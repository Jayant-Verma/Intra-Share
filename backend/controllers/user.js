...
exports.forgotPassword = async (req, res) => {
    try {
        ...
        const message = `You are receiving this email because you (or someone else) have requested to reset your password. Reset your Password by clicking on the link below: \n\n ${resetUrl}\n\nIf you did not request this, please ignore this email and your password will remain unchanged.`;
